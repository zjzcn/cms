...
CREATE TABLE `tb_org` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_mxtrhi0yuxw4h6520qlqp4nf8` (`pid`),
  CONSTRAINT `FK_mxtrhi0yuxw4h6520qlqp4nf8` FOREIGN KEY (`pid`) REFERENCES `tb_org` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES ('1', null, 'admin', 'admin', '96E79218965EB72C92A549DD5A330112', '0', 'zjzcn@126.com', null, null, '0');
INSERT INTO `tb_user` VALUES ('2', null, 'zjz', 'zjz', '96E79218965EB72C92A549DD5A330112', null, '123@12.2', null, null, '0');
